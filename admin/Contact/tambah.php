                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-secondary">Tambah Contact</h6>
                        </div>
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="file">nama</label>
                                    <input type="text" class="form-control" id="file" name="nama" placeholder="masukan link">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" id="nomor_telp" name="no_telp" placeholder="masukan judul">
                                </div>
                                <div class="mb-4">

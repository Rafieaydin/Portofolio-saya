            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php">Table tag</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-secondary">Edit Tag</h6>
                        </div>
                        <div class="card-body">
                            <form action="" method="POST">
                                <div class="form-group mb-4">
                                    <label for="nama_tag">Nama tag</label>
                                    <input type="text" name="id" hidden value="<?= $tag['id'] ?>" id="">
                                    <input type="text" class="form-control" id="nama_tag" name="nama_tag" value="<?= $tag['nama'] ?>" placeholder="masukan nama tag">
                                </div>

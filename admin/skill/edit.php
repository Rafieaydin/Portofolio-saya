...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $skill = query("SELECT skill.id as id_skill, skill.nama, skill.gambar, GROUP_CONCAT(tag.id)  AS id_tag , skill.deskripsi FROM tag_skill 
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-secondary">Edit Data Skill</h6>
                        </div>
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <input type="text" value="<?= $skill['id_skill']  ?>" name="id"  hidden>
                                ...
                                <div class=" form-group">
                                    ...
                                    <input type="text" class="form-control" id="judul" name="judul" placeholder="masukan judul" value="<?= $skill['nama'] ?>">
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="deskripsi"><?= $skill['deskripsi'] ?></textarea>
                                </div>
    ...
    <script>
        $(document).ready(function name(params) {
            ...
            $(".smartsearch_keyword").val([<?= $skill['id_tag'] ?>]).trigger("change");
        })
    </script>

...
$projek  = query("SELECT * FROM projek ORDER BY id DESC");
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="row mt-2">
                                <div class="col-md-10">
                                    <h5 class="m-0 font-weight-bold text-secondary ">Data Projek</h5>
                                </div>
                                <div class="col-md-2">
                                    <a href="tambah.php" class="btn btn-secondary btn-sm pl-2">Tambah Data
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($projek as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td><?= $value['link'] ?></td>
                                                <td><?= $value['judul'] ?></td>
                                                <td><img src="data:image/jpeg;base64,<?= base64_encode($value['image']) ?>" width="200px" alt=""></td>
                                                <td>
